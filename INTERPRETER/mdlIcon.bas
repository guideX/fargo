...
Dim IcoDir As ICON_DIR, IcoDirEntry As ICON_DIR_ENTRY, tBits As DIB_BITS, Icons() As IconDescriptor, lngRet As Long, BytesRead As Long, hSource As Long, hDest As Long, ResTree As Long
...
On Local Error GoTo ErrHandler
Dim tDir As ICON_DIR, BytesRead As Long
If (hFile > 0) Then
...
Exit Function
ErrHandler:
    ProcessRuntimeError Err.Number, Err.Description, "Public Function Valid_ICO(hFile As Long) As Boolean"
End Function
