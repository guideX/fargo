...
Else
    SaveDialog = ""
End If
If Err.Number <> 0 Then ProcessRuntimeError Err.Number, Err.Description, "Function SaveDialog(Form1 As Form, Filter As String, Title As String, InitDir As String) As String"
End Function
...
Else
    OpenDialog = ""
End If
If Err.Number <> 0 Then ProcessRuntimeError Err.Number, Err.Description, "Function OpenDialog(Form1 As Form, Filter As String, Title As String, InitDir As String) As String"
End Function
