...
Begin VB.Form frmForm 
   ...
   ScaleHeight     =   2970
   ScaleWidth      =   4680
   Begin Fargo.XPButton cmdSkinnedButton 
      Height          =   375
      Left            =   120
      TabIndex        =   15
      Top             =   2520
...
'Private Sub cmdSkinnedButton_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
'Set lCurrentObject = cmdSkinnedButton
'SetHashMarks cmdSkinnedButton.Left, cmdSkinnedButton(Index).Top, cmdSkinnedButton(Index).Width, cmdSkinnedButton(Index).Height
